...
class RecWidgets(widgets.Container):
    ...
    def reset_deconv_button_callbacks(self, on_deconv_callback):
    ...
    def reset_tracer_button_callbacks(self, on_tracer_callback):
    ...
    def reset_revoke_button_callbacks(self, on_revoke_callback):
    ...
    def reset_next_task_button_callbacks(self, on_next_task_callback):
